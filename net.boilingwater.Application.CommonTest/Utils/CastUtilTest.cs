...
namespace net.boilingwater.Application.CommonTest
{
    /// <summary>
    ...
    public class CastUtilTest
    {
        ...
        public static TestCaseData[] ToDecimalTestSource =
        {
        ...
        public static TestCaseData[] ToIntegerTestSource =
        {
        ...
        /// <param name="obj">cast target</param>
        /// <returns>cast result</returns>
        [TestCaseSource(nameof(ToUnsigndIntegerTestSource))]
        public uint ToUnsigndIntegerTest(object obj)
        {
            return CastUtil.ToUnsignedInteger(obj);
        }
        public static TestCaseData[] ToUnsigndIntegerTestSource =
        {
        ...
        public static TestCaseData[] ToLongTestSource =
        {
        ...
        public static TestCaseData[] ToUnsignedLongTestSource =
        {
        ...
        public static TestCaseData[] ToDoubleTestSource =
        {
        ...
        public static TestCaseData[] ToBooleanTestSource =
        {
        ...
        public static TestCaseData[] ToStringTestSource =
        {
